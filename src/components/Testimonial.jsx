          ...
          {testimonialdata.map(({ id, name, text, img }) => {
            return (
              <div key={id} className="my-6    ">
                <div className=" flex flex-col justify-center items-center  bg-gray-200  text-center  rounded-xl ">
                  <img 
                    src={image}
                    alt=""
                    className="w-10  h-10 object-cover rounded-full block mx-auto"
                  />
                  <p className=" text-gray-500 text-xs leading-relaxed mb-4 "> {text}</p>
